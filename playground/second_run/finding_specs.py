...
with open(f"to_compute_{basis_desc}.txt", "r") as f:
    bases = eval(f.readline())

bases_to_run = bases[576:612]  # can take a subset of the bases in the file
part = 17
    ...
    for pack in all_packs:
        ...
        try:
            ...
            if spec_count == brute_force_count:
                ...
                with open(f"{basis_desc}/{Av(basis)}_{pack.name}.json", "w") as f:
                    f.write(json_spec)
            else:
